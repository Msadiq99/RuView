...
> Note: This firmware is intended for **ESP32-S3 or ESP32-C6 only**. The original ESP32 and ESP32-C3 are unsupported for the CSI node because they are single-core and cannot run the real-time CSI DSP pipeline.
